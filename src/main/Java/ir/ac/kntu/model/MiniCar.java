...
public class MiniCar extends Vehicle implements Runnable{
    ...
    public MiniCar(double maxV, double v, double aP, double aN,Location location, Path nowPath,double distanceInNowPath, Rectangle shape, int id,int selectColor,double fasele) {
